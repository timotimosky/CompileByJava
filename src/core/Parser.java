...
/*****************************************内部类************开始********************************************************/	
    ...
    protected static class Leaf extends Element {
        ...
        {
            Token t = lexer.read();
            if (t.type.equals(Type.Identifier))
...
/*****************************************内部类************end********************************************************/
    ...
    //向语法规则中添加终结符（除保留字 reserved 外的标识符）
    public Parser identifier(HashSet<String> reserved) {
        return identifier(null, reserved);
    }
    
    //向语法规则中添加终结符（除保留字reserved 外的标识符）
